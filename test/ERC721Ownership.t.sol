...
import {ERC721OwnershipHookImpl} from "../src/implementation/ERC721OwnershipHookImpl.sol";
import {MockERC721} from "../src/mock/MockERC721.sol";

contract ERC721OwnershipTest is Test, Deployers, GasSnapshot {
    using PoolIdLibrary for IPoolManager.PoolKey;
    using PoolIdLibrary for PoolId;
    using CurrencyLibrary for Currency;

    ERC721OwnershipHook erc721Ownership =
        ERC721OwnershipHook(address(uint160(Hooks.BEFORE_SWAP_FLAG)));
    ...
    function setUp() public {
        ...
        ERC721OwnershipHookImpl impl = new ERC721OwnershipHookImpl(
            manager,
            erc721,
            erc721Ownership
        );
        (, bytes32[] memory writes) = vm.accesses(address(impl));
        vm.etch(address(erc721Ownership), address(impl).code);
    ...
    function test_OwnerSwapAllowed() public {
        ...
        erc721.mint(address(swapRouter), 1);
    ...
    function test_NonOwner_Reverts() public {
        ...
        vm.expectRevert(ERC721OwnershipHook.NotNftOwner.selector);
        swapRouter.swap(poolKey, params, testSettings);
    }
}
